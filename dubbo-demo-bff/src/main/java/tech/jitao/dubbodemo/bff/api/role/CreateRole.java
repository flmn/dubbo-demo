...
@RestController(CreateRole.PATH)
@CrossOrigin
public class CreateRole {
    static final String PATH = "/role/create-role";
    ...
    public ApiResult process(@Validated @RequestBody Request request,
        ...
        role.setCreateStaff(staffId);

        return ApiResult.okWithData(new RoleDto(roleService.createRole(role)));
    }
